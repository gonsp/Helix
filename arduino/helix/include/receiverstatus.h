 ...
 *
 * @brief      Arduino Header of the ReceiverStatus object. This file has been
 ...
 */
union {
    ReceiverStatusDataPacked data;
    byte arr[RECEIVERSTATUS_NUMBYTES];
 } ReceiverStatusDataUnion;
