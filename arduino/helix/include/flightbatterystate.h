 ...
 *
 * @brief      Arduino Header of the FlightBatteryState object. This file has been
 ...
 */
union {
    FlightBatteryStateDataPacked data;
    byte arr[FLIGHTBATTERYSTATE_NUMBYTES];
 } FlightBatteryStateDataUnion;
