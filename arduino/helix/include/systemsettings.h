 ...
 *
 * @brief      Arduino Header of the SystemSettings object. This file has been
 ...
 */
union {
    SystemSettingsDataPacked data;
    byte arr[SYSTEMSETTINGS_NUMBYTES];
 } SystemSettingsDataUnion;
