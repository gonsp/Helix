 ...
 *
 * @brief      Arduino Header of the AirspeedSensor object. This file has been
 ...
 */
union {
    AirspeedSensorDataPacked data;
    byte arr[AIRSPEEDSENSOR_NUMBYTES];
 } AirspeedSensorDataUnion;
