 ...
 *
 * @brief      Arduino Header of the HwSettings object. This file has been
...
#include <stdbool.h>
/* Object constants */
#define HWSETTINGS_OBJID 0x36E341AE
...
typedef enum __attribute__ ((__packed__)) {
    ...
    HWSETTINGS_RM_RCVRPORT_IBUS=18
 ...
 */
union {
    HwSettingsDataPacked data;
    byte arr[HWSETTINGS_NUMBYTES];
 } HwSettingsDataUnion;
