 ...
 *
 * @brief      Arduino Header of the CameraStabSettings object. This file has been
 ...
 */
union {
    CameraStabSettingsDataPacked data;
    byte arr[CAMERASTABSETTINGS_NUMBYTES];
 } CameraStabSettingsDataUnion;
