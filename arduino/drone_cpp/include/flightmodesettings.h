 ...
 *
 * @brief      Arduino Header of the FlightModeSettings object. This file has been
...
#include <stdbool.h>
/* Object constants */
#define FLIGHTMODESETTINGS_OBJID 0x1577AA5E
 ...
 */
union {
    FlightModeSettingsDataPacked data;
    byte arr[FLIGHTMODESETTINGS_NUMBYTES];
 } FlightModeSettingsDataUnion;
