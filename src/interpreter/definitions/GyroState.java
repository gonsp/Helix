 ...
 *             The filtered rotation sensor data.
 *
...
generated from gyrostate.xml
 **/
public class GyroState extends UAVDataObject {
	...
	public GyroState() {
		...
		List<String> SensorReadTimestampElemNames = new ArrayList<String>();
		SensorReadTimestampElemNames.add("0");
		fields.add( new UAVObjectField("SensorReadTimestamp", "tick", UAVObjectField.FieldType.UINT32, SensorReadTimestampElemNames, null) );
	 ...
	 */
	public GyroState GetInstance(UAVObjectManager objMngr, long instID)
	{
	    return (GyroState)(objMngr.getObject(GyroState.OBJID, instID));
	}

	// Constants
	protected static final long OBJID = 0x1A163914l;
	protected static final String NAME = "GyroState";
	protected static String DESCRIPTION = "The filtered rotation sensor data.";
