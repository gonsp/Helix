...
public class EKFConfiguration extends UAVDataObject {
	...
	public EKFConfiguration() {
		...
		List<String> MapMagnetometerToHorizontalPlaneElemNames = new ArrayList<String>();
		MapMagnetometerToHorizontalPlaneElemNames.add("0");
		List<String> MapMagnetometerToHorizontalPlaneEnumOptions = new ArrayList<String>();
		MapMagnetometerToHorizontalPlaneEnumOptions.add("False");
		MapMagnetometerToHorizontalPlaneEnumOptions.add("True");
		fields.add( new UAVObjectField("MapMagnetometerToHorizontalPlane", "bool", UAVObjectField.FieldType.ENUM, MapMagnetometerToHorizontalPlaneElemNames, MapMagnetometerToHorizontalPlaneEnumOptions) );
	...
	{
		getField("P").setValue(25,0);
		getField("P").setValue(25,1);
		getField("P").setValue(25,2);
		getField("P").setValue(5,3);
		getField("P").setValue(5,4);
		getField("P").setValue(5,5);
		getField("P").setValue(1e-05,6);
		getField("P").setValue(1e-05,7);
		getField("P").setValue(1e-05,8);
		getField("P").setValue(1e-05,9);
		getField("P").setValue(1e-06,10);
		getField("P").setValue(1e-06,11);
		getField("P").setValue(1e-06,12);
		getField("Q").setValue(0.001,0);
		getField("Q").setValue(0.001,1);
		getField("Q").setValue(0.001,2);
		getField("Q").setValue(0.003,3);
		getField("Q").setValue(0.003,4);
		getField("Q").setValue(0.003,5);
		getField("Q").setValue(1e-06,6);
		getField("Q").setValue(1e-06,7);
		getField("Q").setValue(1e-06,8);
		getField("R").setValue(0.1,0);
		getField("R").setValue(0.1,1);
		getField("R").setValue(1e+06,2);
		getField("R").setValue(0.01,3);
		getField("R").setValue(0.01,4);
		getField("R").setValue(0.01,5);
		...
		getField("MapMagnetometerToHorizontalPlane").setValue("True");
	...
	// Constants
	protected static final long OBJID = 0x5D1D071Al;
