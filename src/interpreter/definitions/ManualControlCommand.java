 ...
 ******************************************************************************
 *
 * @file       ManualControlCommand.java
 * @author     The OpenPilot Team, http://www.openpilot.org Copyright (C) 2010.
 * @brief      Template for an uavobject in java
 *             This is a autogenerated file!! Do not modify and expect a result.
 *             The output from the @ref ManualControlModule which decodes the receiver inputs. Overriden by GCS for fly-by-wire control.
 *
...
public class ManualControlCommand extends UAVDataObject {
	...
	public ManualControlCommand() {
		...
		List<String> ThrustElemNames = new ArrayList<String>();
		ThrustElemNames.add("0");
		fields.add( new UAVObjectField("Thrust", "%", UAVObjectField.FieldType.FLOAT32, ThrustElemNames, null) );
		...
		List<String> FlightModeSwitchPositionElemNames = new ArrayList<String>();
		FlightModeSwitchPositionElemNames.add("0");
		fields.add( new UAVObjectField("FlightModeSwitchPosition", "", UAVObjectField.FieldType.UINT8, FlightModeSwitchPositionElemNames, null) );
	...
	{
		getField("FlightModeSwitchPosition").setValue(0);
	...
	public UAVDataObject getDefaultInstance(){
		return new ManualControlCommand();
	}
	...
	// Constants
	protected static final long OBJID = 0x265BA97El;
	protected static final String NAME = "ManualControlCommand";
	protected static String DESCRIPTION = "The output from the @ref ManualControlModule which decodes the receiver inputs. Overriden by GCS for fly-by-wire control.";
