...
generated from barosensor.xml
 **/
public class BaroSensor extends UAVDataObject {
	...
	public BaroSensor() {
		...
		fields.add( new UAVObjectField("Pressure", "Pa", UAVObjectField.FieldType.FLOAT32, PressureElemNames, null) );
	...
	// Constants
	protected static final long OBJID = 0x48120EA6l;
	protected static final String NAME = "BaroSensor";
