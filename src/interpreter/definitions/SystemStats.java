...
public class SystemStats extends UAVDataObject {
	...
	public SystemStats() {
		...
		fields.add( new UAVObjectField("HeapRemaining", "bytes", UAVObjectField.FieldType.UINT32, HeapRemainingElemNames, null) );

		List<String> CPUIdleTicksElemNames = new ArrayList<String>();
		CPUIdleTicksElemNames.add("0");
		fields.add( new UAVObjectField("CPUIdleTicks", "unit", UAVObjectField.FieldType.UINT32, CPUIdleTicksElemNames, null) );

		List<String> CPUZeroLoadTicksElemNames = new ArrayList<String>();
		CPUZeroLoadTicksElemNames.add("0");
		fields.add( new UAVObjectField("CPUZeroLoadTicks", "unit", UAVObjectField.FieldType.UINT32, CPUZeroLoadTicksElemNames, null) );
		...
		List<String> SystemModStackRemainingElemNames = new ArrayList<String>();
		SystemModStackRemainingElemNames.add("0");
		fields.add( new UAVObjectField("SystemModStackRemaining", "bytes", UAVObjectField.FieldType.UINT16, SystemModStackRemainingElemNames, null) );

		List<String> SysSlotsFreeElemNames = new ArrayList<String>();
		SysSlotsFreeElemNames.add("0");
		fields.add( new UAVObjectField("SysSlotsFree", "slots", UAVObjectField.FieldType.UINT16, SysSlotsFreeElemNames, null) );

		List<String> SysSlotsActiveElemNames = new ArrayList<String>();
		SysSlotsActiveElemNames.add("0");
		fields.add( new UAVObjectField("SysSlotsActive", "slots", UAVObjectField.FieldType.UINT16, SysSlotsActiveElemNames, null) );

		List<String> UsrSlotsFreeElemNames = new ArrayList<String>();
		UsrSlotsFreeElemNames.add("0");
		fields.add( new UAVObjectField("UsrSlotsFree", "slots", UAVObjectField.FieldType.UINT16, UsrSlotsFreeElemNames, null) );

		List<String> UsrSlotsActiveElemNames = new ArrayList<String>();
		UsrSlotsActiveElemNames.add("0");
		fields.add( new UAVObjectField("UsrSlotsActive", "slots", UAVObjectField.FieldType.UINT16, UsrSlotsActiveElemNames, null) );
	...
	// Constants
	protected static final long OBJID = 0xF1EC270El;
