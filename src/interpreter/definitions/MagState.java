...
generated from magstate.xml
 **/
public class MagState extends UAVDataObject {
	...
	public MagState() {
		...
		List<String> SourceElemNames = new ArrayList<String>();
		SourceElemNames.add("0");
		List<String> SourceEnumOptions = new ArrayList<String>();
		SourceEnumOptions.add("Invalid");
		SourceEnumOptions.add("OnBoard");
		SourceEnumOptions.add("Aux");
		fields.add( new UAVObjectField("Source", "", UAVObjectField.FieldType.ENUM, SourceElemNames, SourceEnumOptions) );
	...
	{
		getField("Source").setValue("Invalid");
	 ...
	 */
	public MagState GetInstance(UAVObjectManager objMngr, long instID)
	{
	    return (MagState)(objMngr.getObject(MagState.OBJID, instID));
	}

	// Constants
	protected static final long OBJID = 0x9FFEAA0Cl;
	protected static final String NAME = "MagState";
	protected static String DESCRIPTION = "The filtered magnet vector.";
