 ...
 ******************************************************************************
 *
 * @file       AttitudeState.java
 * @author     The OpenPilot Team, http://www.openpilot.org Copyright (C) 2010.
 * @brief      Template for an uavobject in java
 *             This is a autogenerated file!! Do not modify and expect a result.
 *             The updated Attitude estimation from @ref StateEstimationModule.
 *
...
generated from attitudestate.xml
 **/
public class AttitudeState extends UAVDataObject {

	public AttitudeState() {
		...
		List<String> NavYawElemNames = new ArrayList<String>();
		NavYawElemNames.add("0");
		fields.add( new UAVObjectField("NavYaw", "degrees", UAVObjectField.FieldType.FLOAT32, NavYawElemNames, null) );
	...
	// Constants
	protected static final long OBJID = 0x7421C7BAl;
	protected static final String NAME = "AttitudeState";
	protected static String DESCRIPTION = "The updated Attitude estimation from @ref StateEstimationModule.";
