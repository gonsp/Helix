...
public class ActuatorCommand extends UAVDataObject {
	...
	public ActuatorCommand() {
		...
		fields.add( new UAVObjectField("UpdateTime", "ms", UAVObjectField.FieldType.UINT16, UpdateTimeElemNames, null) );
	...
	// Constants
	protected static final long OBJID = 0xB8229FE4l;
