 ...
 ******************************************************************************
 *
 * @file       GPSVelocitySensor.java
 * @author     The OpenPilot Team, http://www.openpilot.org Copyright (C) 2010.
 * @brief      Template for an uavobject in java
 *             This is a autogenerated file!! Do not modify and expect a result.
 *             Raw GPS velocity in NED frame and m/s from @ref GPSModule.
 *
...
generated from gpsvelocitysensor.xml
 **/
public class GPSVelocitySensor extends UAVDataObject {

	public GPSVelocitySensor() {
	...
	public UAVDataObject getDefaultInstance(){
		return new GPSVelocitySensor();
	}

	/**
	 * Static function to retrieve an instance of the object.
	 */
	public GPSVelocitySensor GetInstance(UAVObjectManager objMngr, long instID)
	{
	    return (GPSVelocitySensor)(objMngr.getObject(GPSVelocitySensor.OBJID, instID));
	}

	// Constants
	protected static final long OBJID = 0xBC57454l;
	protected static final String NAME = "GPSVelocitySensor";
	protected static String DESCRIPTION = "Raw GPS velocity in NED frame and m/s from @ref GPSModule.";
