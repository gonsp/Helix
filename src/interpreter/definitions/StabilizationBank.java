...
generated from stabilizationbank.xml
 **/
public class StabilizationBank extends UAVDataObject {

	public StabilizationBank() {
	...
	public void setDefaultFieldValues()
	{
		...
		getField("ManualRate").setValue(175,2);
		getField("MaximumRate").setValue(300,0);
		getField("MaximumRate").setValue(300,1);
		getField("MaximumRate").setValue(50,2);
		getField("RollMax").setValue(42);
		getField("PitchMax").setValue(42);
		getField("YawMax").setValue(42);
	...
	public UAVDataObject getDefaultInstance(){
		return new StabilizationBank();
	}

	/**
	 * Static function to retrieve an instance of the object.
	 */
	public StabilizationBank GetInstance(UAVObjectManager objMngr, long instID)
	{
	    return (StabilizationBank)(objMngr.getObject(StabilizationBank.OBJID, instID));
	}

	// Constants
	protected static final long OBJID = 0x373871F0l;
	protected static final String NAME = "StabilizationBank";
