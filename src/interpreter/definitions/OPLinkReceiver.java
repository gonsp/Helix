 ...
 ******************************************************************************
 *
 * @file       OPLinkReceiver.java
 * @author     The OpenPilot Team, http://www.openpilot.org Copyright (C) 2010.
 * @brief      Template for an uavobject in java
 *             This is a autogenerated file!! Do not modify and expect a result.
 *             A receiver channel group carried over the OPLink radio.
 *
...
generated from oplinkreceiver.xml
 **/
public class OPLinkReceiver extends UAVDataObject {

	public OPLinkReceiver() {
		...
		ChannelElemNames.add("12");
		ChannelElemNames.add("13");
		ChannelElemNames.add("14");
		ChannelElemNames.add("15");
	...
	// Constants
	protected static final long OBJID = 0xD29CFD2l;
	protected static final String NAME = "OPLinkReceiver";
	protected static String DESCRIPTION = "A receiver channel group carried over the OPLink radio.";
