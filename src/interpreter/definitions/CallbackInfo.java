...
public class CallbackInfo extends UAVDataObject {
	...
	public CallbackInfo() {
		...
		RunningTimeElemNames.add("CameraControl");
		RunningTimeElemNames.add("DebugLog");
		...
		StackRemainingElemNames.add("CameraControl");
		StackRemainingElemNames.add("DebugLog");
		...
		RunningElemNames.add("CameraControl");
		RunningElemNames.add("DebugLog");
	...
	// Constants
	protected static final long OBJID = 0xC4C3A438l;
