...
public class MixerStatus extends UAVDataObject {
	...
	public MixerStatus() {
		...
		List<String> Mixer11ElemNames = new ArrayList<String>();
		Mixer11ElemNames.add("0");
		fields.add( new UAVObjectField("Mixer11", "", UAVObjectField.FieldType.FLOAT32, Mixer11ElemNames, null) );

		List<String> Mixer12ElemNames = new ArrayList<String>();
		Mixer12ElemNames.add("0");
		fields.add( new UAVObjectField("Mixer12", "", UAVObjectField.FieldType.FLOAT32, Mixer12ElemNames, null) );
	...
	// Constants
	protected static final long OBJID = 0x354C0F40l;
