...
public class GPSSatellites extends UAVDataObject {
	...
	public GPSSatellites() {
		...
		fields.add( new UAVObjectField("Azimuth", "degrees", UAVObjectField.FieldType.INT16, AzimuthElemNames, null) );
		...
		PRNElemNames.add("14");
		PRNElemNames.add("15");
		fields.add( new UAVObjectField("PRN", "", UAVObjectField.FieldType.UINT8, PRNElemNames, null) );
		...
		fields.add( new UAVObjectField("Elevation", "degrees", UAVObjectField.FieldType.INT8, ElevationElemNames, null) );
	...
	// Constants
	protected static final long OBJID = 0xC555B700l;
