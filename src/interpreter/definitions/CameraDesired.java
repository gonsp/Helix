...
public class CameraDesired extends UAVDataObject {
	...
	public CameraDesired() {
		...
		List<String> RollOrServo1ElemNames = new ArrayList<String>();
		RollOrServo1ElemNames.add("0");
		fields.add( new UAVObjectField("RollOrServo1", "", UAVObjectField.FieldType.FLOAT32, RollOrServo1ElemNames, null) );

		List<String> PitchOrServo2ElemNames = new ArrayList<String>();
		PitchOrServo2ElemNames.add("0");
		fields.add( new UAVObjectField("PitchOrServo2", "", UAVObjectField.FieldType.FLOAT32, PitchOrServo2ElemNames, null) );
		...
		List<String> TriggerElemNames = new ArrayList<String>();
		TriggerElemNames.add("0");
		fields.add( new UAVObjectField("Trigger", "", UAVObjectField.FieldType.FLOAT32, TriggerElemNames, null) );
	...
	// Constants
	protected static final long OBJID = 0x6DFEE41El;
