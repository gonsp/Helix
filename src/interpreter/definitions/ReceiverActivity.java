...
public class ReceiverActivity extends UAVDataObject {
	...
	public ReceiverActivity() {
		...
		ActiveGroupEnumOptions.add("DSM (RcvrPort)");
		ActiveGroupEnumOptions.add("S.Bus");
		ActiveGroupEnumOptions.add("EX.Bus");
		ActiveGroupEnumOptions.add("HoTT");
		ActiveGroupEnumOptions.add("SRXL");
		ActiveGroupEnumOptions.add("IBus");
		ActiveGroupEnumOptions.add("GCS");
		ActiveGroupEnumOptions.add("OPLink");
		ActiveGroupEnumOptions.add("OpenLRS");
	...
	// Constants
	protected static final long OBJID = 0xA00CB4AAl;
