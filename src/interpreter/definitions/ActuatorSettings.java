...
public class ActuatorSettings extends UAVDataObject {
	...
	public ActuatorSettings() {
		...
		List<String> DShotModeElemNames = new ArrayList<String>();
		DShotModeElemNames.add("0");
		fields.add( new UAVObjectField("DShotMode", "kHz", UAVObjectField.FieldType.UINT16, DShotModeElemNames, null) );
	...
	public void setDefaultFieldValues()
	{
		...
		getField("DShotMode").setValue(600);
	...
	// Constants
	protected static final long OBJID = 0x70500090l;
