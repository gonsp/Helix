...
generated from receiverstatus.xml
 **/
public class ReceiverStatus extends UAVDataObject {
	...
	public ReceiverStatus() {
		...
		List<String> QualityElemNames = new ArrayList<String>();
		QualityElemNames.add("0");
		fields.add( new UAVObjectField("Quality", "%", UAVObjectField.FieldType.UINT8, QualityElemNames, null) );
	 ...
	 */
	public ReceiverStatus GetInstance(UAVObjectManager objMngr, long instID)
	{
	    return (ReceiverStatus)(objMngr.getObject(ReceiverStatus.OBJID, instID));
	}

	// Constants
	protected static final long OBJID = 0xFD24EDF2l;
	protected static final String NAME = "ReceiverStatus";
	protected static String DESCRIPTION = "Receiver status.";
