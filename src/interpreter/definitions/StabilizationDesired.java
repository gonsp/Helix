 ...
 ******************************************************************************
 *
 * @file       StabilizationDesired.java
...
public class StabilizationDesired extends UAVDataObject {
	...
	public StabilizationDesired() {
		...
		StabilizationModeElemNames.add("Thrust");
		List<String> StabilizationModeEnumOptions = new ArrayList<String>();
		StabilizationModeEnumOptions.add("Manual");
		StabilizationModeEnumOptions.add("Rate");
		StabilizationModeEnumOptions.add("RateTrainer");
		...
		StabilizationModeEnumOptions.add("Acro+");
		StabilizationModeEnumOptions.add("Rattitude");
		StabilizationModeEnumOptions.add("AltitudeHold");
		StabilizationModeEnumOptions.add("AltitudeVario");
		StabilizationModeEnumOptions.add("CruiseControl");
		StabilizationModeEnumOptions.add("SystemIdent");
	...
	public UAVDataObject getDefaultInstance(){
		return new StabilizationDesired();
	}
	...
	// Constants
	protected static final long OBJID = 0x5146807Cl;
