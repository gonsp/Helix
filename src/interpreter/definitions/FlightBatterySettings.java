 ...
 ******************************************************************************
 *
 * @file       FlightBatterySettings.java
...
public class FlightBatterySettings extends UAVDataObject {
	...
	public FlightBatterySettings() {
		...
		List<String> CellVoltageThresholdsElemNames = new ArrayList<String>();
		CellVoltageThresholdsElemNames.add("Warning");
		CellVoltageThresholdsElemNames.add("Critical");
		fields.add( new UAVObjectField("CellVoltageThresholds", "V", UAVObjectField.FieldType.FLOAT32, CellVoltageThresholdsElemNames, null) );
		...
		List<String> ResetConsumedEnergyElemNames = new ArrayList<String>();
		ResetConsumedEnergyElemNames.add("0");
		List<String> ResetConsumedEnergyEnumOptions = new ArrayList<String>();
		ResetConsumedEnergyEnumOptions.add("False");
		ResetConsumedEnergyEnumOptions.add("True");
		fields.add( new UAVObjectField("ResetConsumedEnergy", "bool", UAVObjectField.FieldType.ENUM, ResetConsumedEnergyElemNames, ResetConsumedEnergyEnumOptions) );
	...
	{
		getField("Capacity").setValue(0);
		getField("CellVoltageThresholds").setValue(3.4,0);
		getField("CellVoltageThresholds").setValue(3.1,1);
		getField("SensorCalibrations").setValue(1,0);
		getField("SensorCalibrations").setValue(1,1);
		getField("SensorCalibrations").setValue(0,2);
		getField("SensorCalibrations").setValue(0,3);
		getField("Type").setValue("LiPo");
		getField("NbCells").setValue(0);
		getField("ResetConsumedEnergy").setValue("False");
	...
	public UAVDataObject getDefaultInstance(){
		return new FlightBatterySettings();
	}
	...
	// Constants
	protected static final long OBJID = 0x2B081FC0l;
