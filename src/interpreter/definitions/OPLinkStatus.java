...
public class OPLinkStatus extends UAVDataObject {
	...
	public OPLinkStatus() {
		...
		List<String> AFCCorrectionElemNames = new ArrayList<String>();
		AFCCorrectionElemNames.add("0");
		fields.add( new UAVObjectField("AFCCorrection", "Hz", UAVObjectField.FieldType.INT32, AFCCorrectionElemNames, null) );
	...
	public void setDefaultFieldValues()
	{
		...
		getField("AFCCorrection").setValue(0);
	...
	// Constants
	protected static final long OBJID = 0xC4A03B86l;
