...
public class PathAction extends UAVDataObject {
	...
	public PathAction() {
		...
		fields.add( new UAVObjectField("JumpDestination", "waypoint", UAVObjectField.FieldType.INT16, JumpDestinationElemNames, null) );

		List<String> ErrorDestinationElemNames = new ArrayList<String>();
		ErrorDestinationElemNames.add("0");
		fields.add( new UAVObjectField("ErrorDestination", "waypoint", UAVObjectField.FieldType.INT16, ErrorDestinationElemNames, null) );
		...
		ModeEnumOptions.add("AutoTakeoff");
	...
	// Constants
	protected static final long OBJID = 0x6048D4F4l;
