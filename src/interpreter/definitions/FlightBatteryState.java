...
public class FlightBatteryState extends UAVDataObject {
	...
	public FlightBatteryState() {
		...
		List<String> NbCellsAutodetectedElemNames = new ArrayList<String>();
		NbCellsAutodetectedElemNames.add("0");
		List<String> NbCellsAutodetectedEnumOptions = new ArrayList<String>();
		NbCellsAutodetectedEnumOptions.add("False");
		NbCellsAutodetectedEnumOptions.add("True");
		fields.add( new UAVObjectField("NbCellsAutodetected", "bool", UAVObjectField.FieldType.ENUM, NbCellsAutodetectedElemNames, NbCellsAutodetectedEnumOptions) );
	...
	public void setDefaultFieldValues()
	{
		...
		getField("NbCellsAutodetected").setValue("False");
	...
	// Constants
	protected static final long OBJID = 0x26962352l;
