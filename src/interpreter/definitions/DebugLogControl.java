...
generated from debuglogcontrol.xml
 **/
public class DebugLogControl extends UAVDataObject {
	...
	public DebugLogControl() {
		...
		OperationEnumOptions.add("None");
		OperationEnumOptions.add("Retrieve");
		OperationEnumOptions.add("FormatFlash");
	...
	public UAVDataObject getDefaultInstance(){
		return new DebugLogControl();
	}

	/**
	 * Static function to retrieve an instance of the object.
	 */
	public DebugLogControl GetInstance(UAVObjectManager objMngr, long instID)
	{
	    return (DebugLogControl)(objMngr.getObject(DebugLogControl.OBJID, instID));
	}

	// Constants
	protected static final long OBJID = 0xC39642FCl;
	protected static final String NAME = "DebugLogControl";
	protected static String DESCRIPTION = "Log Control Object - Used to issue commands to the on board logging system";
