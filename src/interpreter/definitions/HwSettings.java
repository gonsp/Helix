...
public class HwSettings extends UAVDataObject {
	...
	public HwSettings() {
		...
		RM_RcvrPortEnumOptions.add("PPM+HoTT Telemetry");
		...
		RM_RcvrPortEnumOptions.add("HoTT Telemetry");
		RM_RcvrPortEnumOptions.add("IBus");
		...
		RM_MainPortEnumOptions.add("HoTT Telemetry");
		...
		RM_FlexiPortEnumOptions.add("HoTT Telemetry");
		...
		USB_VCPPortEnumOptions.add("MAVLink");
		...
		RadioAuxStreamEnumOptions.add("DebugConsole");
		RadioAuxStreamEnumOptions.add("Disabled");
		RadioAuxStreamEnumOptions.add("MAVLink");
		RadioAuxStreamEnumOptions.add("ComBridge");
		fields.add( new UAVObjectField("RadioAuxStream", "function", UAVObjectField.FieldType.ENUM, RadioAuxStreamElemNames, RadioAuxStreamEnumOptions) );
		...
		List<String> SBusModeElemNames = new ArrayList<String>();
		SBusModeElemNames.add("0");
		List<String> SBusModeEnumOptions = new ArrayList<String>();
		SBusModeEnumOptions.add("Normal");
		SBusModeEnumOptions.add("Non Inverted");
		fields.add( new UAVObjectField("SBusMode", "", UAVObjectField.FieldType.ENUM, SBusModeElemNames, SBusModeEnumOptions) );
	...
	public void setDefaultFieldValues()
	{
		...
		getField("SBusMode").setValue("Normal");
	...
	// Constants
	protected static final long OBJID = 0x731C1F8l;
