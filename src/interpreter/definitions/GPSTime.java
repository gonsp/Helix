...
public class GPSTime extends UAVDataObject {
	...
	public GPSTime() {
		...
		List<String> MillisecondElemNames = new ArrayList<String>();
		MillisecondElemNames.add("0");
		fields.add( new UAVObjectField("Millisecond", "ms", UAVObjectField.FieldType.INT16, MillisecondElemNames, null) );
	...
	// Constants
	protected static final long OBJID = 0x1E2F477El;
