 ...
 ******************************************************************************
 *
 * @file       AuxMagSensor.java
 * @author     The OpenPilot Team, http://www.openpilot.org Copyright (C) 2010.
 * @brief      Template for an uavobject in java
 *             This is a autogenerated file!! Do not modify and expect a result.
 *             Calibrated sensor data from aux 3 axis magnetometer in MilliGauss.
 *
...
generated from auxmagsensor.xml
 **/
public class AuxMagSensor extends UAVDataObject {
	...
	public UAVDataObject getDefaultInstance(){
		return new AuxMagSensor();
	}

	/**
	 * Static function to retrieve an instance of the object.
	 */
	public AuxMagSensor GetInstance(UAVObjectManager objMngr, long instID)
	{
	    return (AuxMagSensor)(objMngr.getObject(AuxMagSensor.OBJID, instID));
	}

	// Constants
	protected static final long OBJID = 0x9B459A2l;
	protected static final String NAME = "AuxMagSensor";
	protected static String DESCRIPTION = "Calibrated sensor data from aux 3 axis magnetometer in MilliGauss.";
