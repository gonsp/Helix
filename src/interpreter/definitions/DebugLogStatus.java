...
generated from debuglogstatus.xml
 **/
public class DebugLogStatus extends UAVDataObject {

	public DebugLogStatus() {
		...
		List<String> UsedSlotsElemNames = new ArrayList<String>();
		UsedSlotsElemNames.add("0");
		fields.add( new UAVObjectField("UsedSlots", "", UAVObjectField.FieldType.UINT16, UsedSlotsElemNames, null) );

		List<String> FreeSlotsElemNames = new ArrayList<String>();
		FreeSlotsElemNames.add("0");
		fields.add( new UAVObjectField("FreeSlots", "", UAVObjectField.FieldType.UINT16, FreeSlotsElemNames, null) );
	...
	public UAVDataObject getDefaultInstance(){
		return new DebugLogStatus();
	}

	/**
	 * Static function to retrieve an instance of the object.
	 */
	public DebugLogStatus GetInstance(UAVObjectManager objMngr, long instID)
	{
	    return (DebugLogStatus)(objMngr.getObject(DebugLogStatus.OBJID, instID));
	}

	// Constants
	protected static final long OBJID = 0x85A4DAD6l;
	protected static final String NAME = "DebugLogStatus";
	protected static String DESCRIPTION = "Log Status Object, contains log partition status information";
